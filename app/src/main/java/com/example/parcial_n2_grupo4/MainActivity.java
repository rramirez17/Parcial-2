...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        culebra.add(new Culebra("Mamba Negra", "La mamba negra (Dendroaspis polylepis) es una especie de serpiente de la familia Elapidae extremadamente venenosa que habita en diversas zonas del África subsahariana.", R.drawable.mamba_negra));
        culebra.add(new Culebra("Taipán del Interior", "Es una especie de serpiente nativa de Australia y la serpiente terrestre más venenosa del mundo. Una curiosidad es que, cuando muerde, da tres mordidas rápidas en vez de una sola mordida más prolongada. ", R.drawable.taipan_interior));
        culebra.add(new Culebra("Pitón Reticulada", "Es una especie de serpiente propia del sureste asiático y la Wallacea. El Libro Guiness de los Récords tiene como la mayor serpiente descubierta una pitón reticulada capturada en la isla de Célebes, Indonesia, en 1912.", R.drawable.piton_reticulada));
