...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        culebra.add(new Culebra("Cobra Real", "Es la serpiente venenosa más grande que existe. El promedio de su longitud es de 5,1 m pero algunas alcanzan los 6,4 metros. Es una serpiente delgada, de color oliva o pardo, con ojos de color bronce.", R.drawable.cobra_real));
        culebra.add(new Culebra("Mamba Negra", "La mamba negra (Dendroaspis polylepis) es una especie de serpiente de la familia Elapidae extremadamente venenosa que habita en diversas zonas del África subsahariana. Descrita formalmente por Albert Günther en 1864, es la segunda serpiente venenosa de mayor tamaño, después de la cobra real;", R.drawable.mamba_negra));   
        culebra.add(new Culebra("Taipán del Interior", "Es una especie de serpiente nativa de Australia y la serpiente terrestre más venenosa del mundo. Una curiosidad es que, cuando muerde, da tres mordidas rápidas en vez de una sola mordida más prolongada. La razón, no le gusta el contacto físico y no desea estar cerca de otros animales bajo ningún concepto.", R.drawable.taipan_interior));
        culebra.add(new Culebra("Pitón Reticulada", "Es una especie de serpiente propia del sureste asiático y la Wallacea. El Libro Guiness de los Récords tiene como la mayor serpiente descubierta una pitón reticulada capturada en la isla de Célebes, Indonesia, en 1912. Superaba los 8 metros de largo al momento de ser encontrada.", R.drawable.piton_reticulada));
